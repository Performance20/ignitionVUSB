 ...
 */
#define USB_CFG_HAVE_MEASURE_FRAME_LENGTH   1 /*1*/
 ...
 */
#define USB_CFG_VENDOR_NAME     's', 'c', 'h', 'e', 'n', 'i', '.', 'd', 'e'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D', 'i', 'g', 'z', 'u', 'e', 'n', 'd'
 ...
 */
#define USB_CFG_DEVICE_CLASS        0xff/*0*/    /* set to 0 if deferred to interface */
#define USB_CFG_DEVICE_SUBCLASS     0
/* See USB specification if you want to conform to an existing device class.
 * Class 0xff is "vendor specific".
 */
#define USB_CFG_INTERFACE_CLASS     0 /*0x03*/   /* define class here if not at device level */
